...
import { MEXICO_FORM, SECTIONS_MEXICO_FORM, TYPE_PERSON_MEXICO } from 'src/app/shared/forms/mexico_form';
import { IForm, IFormSection } from 'src/app/shared/interfaces/form';
...
export class MexicoFormComponent {
  ...
  readonly MEXICAN_FORM = MEXICO_FORM;
  ...
  ngOnInit(): void {
    ...
    this.mainForm = {...this.MEXICAN_FORM}
  ...
  private setTypeIdByTypePerson(typePerson: string){
    ...
    this.updateList('f_document_type_id', tipo_id, SECTIONS_MEXICO_FORM.INFORMACION_BASICA);
  ...
  private setJuridicaSectionsVisible(){
    const showMoralSections = (Number(this.form.value['tipo_persona']) == TYPE_PERSON_MEXICO.Moral);

    this.setVisibleInput('otras_empresas', showMoralSections, SECTIONS_MEXICO_FORM.INFORMACION_BASICA);
    this.setVisibleInput('pertenece_grupo_empresarial', showMoralSections, SECTIONS_MEXICO_FORM.INFORMACION_BASICA);
    this.setVisibleInput('p_pertenece_grupo_empresarial', showMoralSections, SECTIONS_MEXICO_FORM.INFORMACION_BASICA);

    this.setVisibleInput('acta_constitutiva_file', showMoralSections, SECTIONS_MEXICO_FORM.ANEXOS);

    this.setVisibleSection(showMoralSections, SECTIONS_MEXICO_FORM.INFORMACION_REPRESENTANTES_LEGALES);
    this.setVisibleSection(showMoralSections, SECTIONS_MEXICO_FORM.INFORMACION_JUNTA_DIRECTIVA);
    this.setVisibleSection(showMoralSections, SECTIONS_MEXICO_FORM.INFORMACION_ACCIONISTAS);
    this.setVisibleSection(showMoralSections, SECTIONS_MEXICO_FORM.INFORMACION_BENEFICIARIOS_FINALES);


  }

  private setVisibleInput(inputKey: string, visible: boolean, sectionKey: SECTIONS_MEXICO_FORM ){
  ...
  private setVisibleSection(visible: boolean, sectionKey: SECTIONS_MEXICO_FORM ){
    const sectionIndex = this.mainForm.sections.findIndex( section => section.key == sectionKey)
    const section = this.mainForm.sections[sectionIndex]
  ...
  private updateList(inputKey: string, newList: ISelectBoxOption[], sectionKey: SECTIONS_MEXICO_FORM ){
