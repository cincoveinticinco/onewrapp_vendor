  ...
  sections: [
    {
      ...
      inputs: [
        ...
        },
        {
          ...
          visible: true,
          disabled: false,
          value: 'Personas físicas: firmar el documento  y estar acompañado de copia de los documentos requeridos en el punto VII "Anexos".'
        },
        {
          type: TypeInputForm.Paragraph,
          visible: true,
          disabled: false,
          value: 'Personas morales: el formulario debe ser firmado por el representante legal y estar acompañado de copia de los documentos requeridos en el punto VII "Anexos". '
        },
        {
      ...
      inputs: [
        {
          type: TypeInputForm.Paragraph,
          visible: true,
          value: 'Personas físicas y morales con participación igual o superior al cinco por ciento (5%)',
          disabled: false,
          align: ''
        },
        {
    ...
    },
    {
      ...
      inputs: [
        ...
        },
        {
          type: TypeInputForm.Paragraph,
          visible: true,
          value: 'ix) a. ¿Dentro de los servicios que presta realiza alguna de las siguientes actividades: apuestas, otorgamiento de créditos o préstamos, intermediación en venta de inmuebles, comercialización de obras de arte, recepción de donativos?',
          disabled: false
        },
        {
          label: '',
        ...
        },
        {
          type: TypeInputForm.Paragraph,
          visible: true,
          value: 'b. ¿Ha sido incluido en alguna lista de contribuyente incumplido o condonado por parte del SAT?',
          disabled: false
        },
        {
          label: '',
